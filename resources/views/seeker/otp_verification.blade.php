    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="col-lg-6 col-md-12 offset-lg-3" data-aos="fade-up" data-aos-delay="300">
          <form action="{{ route('seeker_otp_verify', $seeker_details->id) }}" method="post" role="form" class="php-email-form">
            @csrf

            <div class="mb-3">
              <div class="sent-message" style="display:block;">Please enter the One-Time password to verify your account</div>
              <h6 style="margin-top:10px; text-align:center;">A One-Time password has been sent to {{ $seeker_details->country_code.$seeker_details->phone }}</h6>
            </div>
...
$('.resendotp').click(function(){
  var id = '{{ $seeker_details->id }}';
  var _token = '{{ csrf_token() }}';

  $.ajax({
      method: 'POST', // Type of response and matches what we said in the route
      url: '{{ route("donor_save", $seeker_details->id) }}', // This is the url we gave in the route
